...
public static class CSVReader
{
    ...
    public static NewScriptManager ReadScript(int scriptGroupID)
    {
        ...
        scriptMgr.chapter = int.Parse(GetSectionValue(scriptFile, MysSection.chapter));
        scriptMgr.title = GetSectionValue(scriptFile, MysSection.title);
        scriptMgr.explain = GetSectionValue(scriptFile, MysSection.explain);
